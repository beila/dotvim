...
nmap <leader>X :let @/='\<'.expand('<cword>').'\>'<Enter>:Ack!-tc -tcpp "\b<cword>\b"
...
nmap <leader>C :let @/='\<'.expand('<cword>').'\>'<Enter>:Ack!-tc -tcpp --ignore-dir=tests --ignore-dir=thirdparty --ignore-dir=generated --ignore-dir=build --ignore-dir=install "\b<cword>\b"

nmap <leader>m :let @/='\<D\?\zs'.expand('<cword>').'\>'<Enter>:Ack! -tcmake -tmake -tpy -tsh "\bD?<cword>\b"<Enter>
nmap <leader>M :let @/='\<D\?\zs'.expand('<cword>').'\>'<Enter>:Ack! -tcmake -tmake -tpy -tsh "\bD?<cword>\b"
